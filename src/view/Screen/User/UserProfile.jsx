          ...
          >
            ...
            <ModalBody>
              <TextField
                ...
                onChange={(e) =>
                  this.inputHandler(e, "oldPassword", "changePassword")
                }
                placeholder="Enter Old Password"
                type={
                  this.state.changePassword.showPassword ? "text" : "password"
                }
              />
              <TextField
                value={this.state.changePassword.newPassword}
                onChange={(e) =>
                  this.inputHandler(e, "newPassword", "changePassword")
                }
              ...
              <TextField
                ...
                onChange={(e) =>
                  this.inputHandler(e, "confirmPassword", "changePassword")
                }
              ...
              <input
                type="checkbox"
                onChange={(e) => this.checkboxHandler(e, "changePassword")}
                className="mt-3"
                name="showPassword"
              />{" "}
              Show Password
              ...
              <div className="row">
                <div className="col-12 mt-3">
                  <TextField
                    ...
                    placeholder="E-mail"
                    onChange={(e) =>
                      this.inputHandler(e, "email", "editMember")
                    }
                  />
                </div>
              </div>
